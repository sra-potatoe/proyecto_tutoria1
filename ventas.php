...
<script>
    $(document).ready(function() {
        // ... Otro código JavaScript existente ...

        // Evento click para el botón de generar venta
    ...
    function generarVenta() {
        ...
        // Realizar la llamada Ajax para procesar la venta
        $.ajax({
            url: 'ajax.php',
            type: 'GET',
            data: {
            ...
            success: function(response) {
                // Manejar la respuesta de la venta procesada
                if (response && response.id_cliente) {
                    alert('Venta procesada con éxito. ID de venta: ' + response.id_venta);
            ...
            error: function() {
                alert('Error en la llamada Ajax al procesar la venta.');
            }
        });
    }
</script>
